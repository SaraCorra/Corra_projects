...
$$
\theta_1,...,\theta_J|\mu,\tau\sim \prod^J_{j=1}N(\theta_j|\mu,\tau^2)
$$
...
$$
p(\theta_1,...,\theta_j,\mu,\tau^2|y_1,...,y_n) 
$$
$$
\propto p(\mu,\tau^2) p(\theta_1,...,\theta_j|\mu,\tau^2)
p(y_1,...,y_j|\theta_1,...,\theta_j,\mu,\tau^2)
$$
$$
...
<---> I wrote this but it is correct from theoretical point of view of joint vs posterior? <--->
...
### Conditional posterior expected value
...
# Conclusions
1) general reiteration of results
To conclude, 
The analysis did no determine the presence of evidence in favour of effectiveness of beta bl
